  ...
  definition: {
    ...
    notification: {
      ...
      response: {
        ...
        instance_request_invite_decline: '拒绝',
        instance_request_invite_decline_with_message: '拒绝并附带留言',
        instance_request_invite_decline_with_photo: '拒绝并附带照片',
