...
export interface CurrentUser {
  ...
  /**
   *
   * @type {Array<TwoFactorTypes>}
   * @memberof TwoFactorRecoveryCodes
   */
  requiresTwoFactorAuth?: Array<TwoFactorTypes>
  /**
   *
   * @type {UserState}
   * @memberof CurrentUser
...
export const GroupPermissions = {
  ...
  group_instance_plus_ANIME_unlocked: 'group-instance-plus-portal-unlocked',
