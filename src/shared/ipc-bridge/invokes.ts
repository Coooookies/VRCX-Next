...
export type IpcInvokeEvents = {
  ...
  // VRChatInstances
  'vrchat-instances:instance-tracker:get-current-players': () => InstanceUserWithInformation[]
  'vrchat-instances:instance-tracker:get-current-events': () => InstanceEventMessage[]
