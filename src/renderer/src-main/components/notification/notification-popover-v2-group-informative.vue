...
const props = defineProps<{
  ...
  raw: NotificationGlobalRawInformation[typeof NotificationGlobalType.GroupInformativeV2]
}>()
      ...
      <div class="grid flex-1 text-left text-sm leading-tight gap-y-0.5">
        <div class="w-full flex flex-row items-center gap-1 overflow-hidden">
          <p class="flex-1 text-sm truncate">
            ...
            <span class="font-medium text-muted-foreground mr-1">{{ props.base.title }}</span>
          </p>
          <Button
            size="icon"
            variant="ghost"
