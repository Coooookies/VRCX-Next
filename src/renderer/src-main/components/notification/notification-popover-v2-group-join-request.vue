...
const props = defineProps<{
  ...
  raw: NotificationGlobalRawInformation[typeof NotificationGlobalType.GroupJoinRequestV2]
}>()
      ...
      <div class="grid flex-1 text-left text-sm leading-tight gap-y-0.5">
        <div class="w-full flex flex-row items-center gap-1 overflow-hidden">
          <p class="flex-1 text-sm truncate">
            ...
            >
              {{ props.raw.data.userDisplayName }}
            </Button>
            <Button
              as="a"
            ...
            >
              <span class="font-medium text-muted-foreground mr-1">want to join</span>
