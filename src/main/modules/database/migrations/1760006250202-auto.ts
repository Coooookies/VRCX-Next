...
export class Auto1760006250202 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vrchat_cache_avatar_references" ("file_id" varchar(63) PRIMARY KEY NOT NULL, "file_name" text NOT NULL, "author_user_id" varchar(63) NOT NULL, "avatar_name" text, "unity_version" varchar(31), "asset_version" integer, "platform" varchar(31), "release_state" varchar(31), "cache_updated_at" datetime NOT NULL DEFAULT (strftime('%s', 'now') || substr(strftime('%f', 'now'), 4, 3)))`);
        ...
        await queryRunner.query(`CREATE TABLE "vrchat_friend_location_activities" ("activity_id" varchar(63) PRIMARY KEY NOT NULL, "ref_user_id" varchar(63) NOT NULL, "friend_user_id" varchar(63) NOT NULL, "friend_user_name" text, "world_id" varchar(63), "world_name" text, "world_version" integer, "owner_id" varchar(63), "owner_name" text, "instance_id" text, "instance_type" varchar(15) NOT NULL, "recorded_at" datetime NOT NULL DEFAULT (strftime('%s', 'now') || substr(strftime('%f', 'now'), 4, 3)))`);
